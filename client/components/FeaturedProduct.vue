    ...
    <div class="unified_widget pageBanner">
      ...
      <p>
        <b>
          ...
          <a href="#">leader of notable people</a>, or
          <a href="#">Fantasy books</a> like harry potter or Star Wars
    ...
    <div class="bx-root">
      <div class="row">
        <div class="col-sm-5 text-center">
          <div class="bx-root-imag">
            <img src="../static/img/amazonImg.jpg" class="img-fluid" />
          </div>
        </div>
